defmodule PhoenixUeberauthGuardian.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import PhoenixUeberauthGuardian.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&PhoenixUeberauthGuardian.ErrorHelpers.translate_error/1)
