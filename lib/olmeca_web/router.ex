defmodule OlmecaWeb.Router do
  use OlmecaWeb, :router
  ...
  scope "/admin", OlmecaWeb.Admin, as: :admin do
  ...
  # Normal users can only go to the login page
  scope "/app", OlmecaWeb.App, as: :app do
    pipe_through [:browser, :browser_auth] # Use the default browser stack
