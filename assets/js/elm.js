...
var _user$project$Model$initialModel = function (flags) {
	return {flags: flags, pongs: 0};
};
var _user$project$Model$Flags = F2(
	function (a, b) {
		return {socketUrl: a, guardianToken: b};
	});
var _user$project$Model$Model = F2(
	function (a, b) {
		return {flags: a, pongs: b};
	});

var _user$project$Messages$Pong = {ctor: 'Pong'};
var _user$project$Messages$SendPing = {ctor: 'SendPing'};

var _user$project$Subscriptions$credentials = function (model) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'guardian_token',
				_1: _elm_lang$core$Json_Encode$string(model.flags.guardianToken)
			},
			_1: {ctor: '[]'}
		});
};
var _user$project$Subscriptions$channel = function (model) {
	return _saschatimme$elm_phoenix$Phoenix_Channel$withDebug(
		A2(
			_saschatimme$elm_phoenix$Phoenix_Channel$withPayload,
			_user$project$Subscriptions$credentials(model),
			_saschatimme$elm_phoenix$Phoenix_Channel$init('authorized')));
};
...
var _user$project$Subscriptions$subscriptions = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Subscriptions$channel(model),
			_1: {ctor: '[]'}
		});
};

var _user$project$View$bodyView = function (model) {
	var message = function () {
		...
		switch (_p0) {
			...
			case 1:
				return A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(model.pongs),
					' pong received!');
			default:
				return A2(
					_elm_lang$core$Basics_ops['++'],
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_user$project$Messages$SendPing),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Send ping!'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _user$project$View$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$View$bodyView(model),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'SendPing') {
			var push = A2(
				_saschatimme$elm_phoenix$Phoenix_Push$onOk,
				function (_p1) {
					return _user$project$Messages$Pong;
				},
				A2(_saschatimme$elm_phoenix$Phoenix_Push$init, 'authorized', 'ping'));
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				model,
				{
					ctor: '::',
					_0: A2(_saschatimme$elm_phoenix$Phoenix$push, model.flags.socketUrl, push),
					_1: {ctor: '[]'}
				});
		} else {
			return A2(
...
var _user$project$Main$init = function (flags) {
	var model = _user$project$Model$initialModel(flags);
	...
	A2(
		...
		function (guardianToken) {
			return A2(
				...
				function (socketUrl) {
					return _elm_lang$core$Json_Decode$succeed(
						{guardianToken: guardianToken, socketUrl: socketUrl});
				},
				A2(_elm_lang$core$Json_Decode$field, 'socketUrl', _elm_lang$core$Json_Decode$string));
		},
		A2(_elm_lang$core$Json_Decode$field, 'guardianToken', _elm_lang$core$Json_Decode$string)));

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Messages.Msg":{"args":[],"tags":{"SendPing":[],"Pong":[]}}},"aliases":{},"message":"Messages.Msg"},"versions":{"elm":"0.18.0"}});
}
